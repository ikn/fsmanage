...
- An operation causes a change to the filesystem, usually to a single item, and
  is implemented by an :class:`OperationExecutor
  <fsmanage.opexec.OperationExecutor>`.  For example: move, copy, delete.  If
